...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1Ijoia2FoZW5vMTMxMiIsImEiOiJjbDJ2cW0xZTgwZWhsM3BvYTBzM3pjZGRrIn0.cHOwePsZizNWYdlN6AgqLg'; // Creating map with Mapbox

  var map = new mapboxgl.Map({
    container: 'map',
    // container ID (#map in tour.pug)
    style: 'mapbox://styles/kaheno1312/cl2vrce1p001u14p8q7zjf6rt',
    // style URL (created in website)
    scrollZoom: false // center: [-80.243273, 26.0999136], // lng, lat
    // zoom: 10, // zoom level
    // interactive: false,

  });
  var bounds = new mapboxgl.LngLatBounds(); // Makings the map to display location in ".LngLatBounds()"

  locations.forEach(function (loc) {
    // Create marker (CSS custom created icon)
    var el = document.createElement('div'); // Create HTML element
    ...
    .setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")) // popup message
...
var hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); // get alert "class"
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', _context.t0.response.data.message); // to get error from "axios"
...
exports.updateSettings = exports.updateData = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            res = _context.sent;
            if (res.data.status = 'success') (0, _alert.showAlert)('success', 'Your info has been updated');
            _context.next = 10;
            break;
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword' // url from out API (postman)
          ...
          case 4:
            res = _context2.sent;
            if (res.data.status = 'success') (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " has been updated"));
            _context2.next = 11;
            break;
...
// Get Public Key
var stripe = Stripe('pk_test_51Kz7kCIB9kZjHQgvdyGeZWXG1cT1f8SZVg6bcdxnpCQ21vS9QR7lLzFxn9xGzkDqi6I2cfDYouRBVr6s2izKHoU000HI2ybRs1');
...
var userDataForm = document.querySelector('.form-user-data'); // Selecting user data Form

var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); // Get "#book-tour" in "tour.pug"
// DELEGATION
...
if (userDataForm) userDataForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var form = new FormData(); // Create form
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            passwordConfirm = document.getElementById('password-confirm').value; // Using await => So we can clear imput field right away
